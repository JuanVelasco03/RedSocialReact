...
export const Sidebar = () => {
    ...
    const savePublication = async (e) => {
        e.preventDefault();
        //Recoger datos del forumulario
        let newPublication = form;
        newPublication.user = auth._id

        console.log(form)
        
        //Hacer request para guardadr en bd
            ...
            <div className="aside__container">
                ...
                <div className="aside__container-form">
                    ...
                    <form className="container-form__form-post" onSubmit={savePublication} id='publication-form'>
                        {stored == "stored" ?  <strong className='alert alert-success'>Se ha hecho la publicacion</strong> : "" }
                        ...
                        <div className="form-post__inputs">
                            ...
                            <textarea name="text" className="form-post__textarea" onChange={changed} required/>
                        </div>
                        <div className="form-post__inputs">
